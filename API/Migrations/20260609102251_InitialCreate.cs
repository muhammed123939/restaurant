        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Inventories_Menus_MenuItemID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrderPosition = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                name: "OrdersForDeliverys",
                columns: table => new
                {
                    OrdersForDeliveryId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    OrderId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrdersForDeliverys", x => x.OrdersForDeliveryId);
                    table.ForeignKey(
                        name: "FK_OrdersForDeliverys_CustomerAddresses_AddressID",
                        column: x => x.AddressID,
                        principalTable: "CustomerAddresses",
                        principalColumn: "AddressID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrdersForDeliverys_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "OrderID",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_OrdersForDeliverys_Users_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Users",
                        principalColumn: "UserID",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_TableNo",
                table: "Orders",
                column: "TableNo");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersForDeliverys_AddressID",
                table: "OrdersForDeliverys",
                column: "AddressID");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersForDeliverys_EmployeeId",
                table: "OrdersForDeliverys",
                column: "EmployeeId");

            migrationBuilder.CreateIndex(
                name: "IX_OrdersForDeliverys_OrderId",
                table: "OrdersForDeliverys",
                column: "OrderId");
